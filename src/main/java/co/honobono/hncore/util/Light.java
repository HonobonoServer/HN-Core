/*
	Copyright (c) 2015 BeYkeRYkt
	Released under the MIT license
	https://github.com/BeYkeRYkt/LightAPI/blob/master/LICENSE
 */
...
public class Light {
	...
	private static List<ChunkCoord> ccip = new CopyOnWriteArrayList<ChunkCoord>();

	public static void createLight(Location location, int light) {
	...
	private static void collectChunks(Location location) {
		try {
	...
	private static void recalculateBlockLighting(World world, int x, int y, int z) {
	...
	public static void sendUpdateChunks() {
		while (!ccip.isEmpty()) {
	...
	private static void sendPacket(Chunk chunk) {
	...
	private static int distanceTo(Chunk from, Chunk to) {
